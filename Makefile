...
C_FILES=kernel.c ./alloc_simple/phyAlloc.c ./hardware/hw.c ./sched_simple/sched.c ./syscall/syscall.c ./VirtualMemory/vmem.c ./proc_isolation/isolation.c ./VirtualMemory/Mini_Alloc.c ./VirtualMemory/Frames.c ./utilities/utilities.c
